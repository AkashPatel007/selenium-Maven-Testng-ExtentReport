...
public class NewTest14 extends ExtentFactory{
...
*/
	...
	public void beforeTest() throws IOException {
		...
		extent.loadConfig(new File(c.RootFolderPath+"extent-config.xml"));
		test=extent.startTest("NewTest14-"+O.CurrentTime(),"Example.Module1");
	...
	@Test				
	public void Module3NewTest14() throws Exception{
