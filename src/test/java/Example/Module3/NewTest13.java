...
public class NewTest13 {
	...
	public void ReportInitialise(){
		//ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(c.ExtentreportFolderPath+O.CurrentDate()+"/NewTest1.html");
...
/*	@AfterTest
	...
	public void beforeTest() throws IOException {
		extent= ef.getInstance();
		extent.loadConfig(new File(c.RootFolderPath+"extent-config.xml"));
		test=extent.startTest("NewTest13-"+O.CurrentTime(),"Example.Module1");
	...
	@Test				
	public void Module3NewTest13() throws Exception{
