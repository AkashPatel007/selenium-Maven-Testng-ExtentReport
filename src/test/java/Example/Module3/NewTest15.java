...
public class NewTest15 extends ExtentFactory{
...
*/
	...
	public void beforeTest() throws IOException {
		...
		extent.loadConfig(new File(c.RootFolderPath+"extent-config.xml"));
		test=extent.startTest("NewTest15-"+O.CurrentTime(),"Example.Module1");
	...
	@Test				
	public void Module3NewTest15() throws Exception{
