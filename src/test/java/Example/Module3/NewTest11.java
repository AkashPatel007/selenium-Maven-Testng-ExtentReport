...
public class NewTest11 extends ExtentFactory{
...
*/
	...
	public void beforeTest() throws IOException {
		...
		extent.loadConfig(new File(c.RootFolderPath+"extent-config.xml"));
		test=extent.startTest("NewTest11-"+O.CurrentTime(),"Example.Module1");
	...
	@Test				
	public void Module3NewTest11() throws Exception{
