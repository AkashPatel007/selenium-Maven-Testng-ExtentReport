...
public class NewTest16 extends ExtentFactory{
...
*/
	...
	public void beforeTest() throws IOException {
		...
		extent.loadConfig(new File(c.RootFolderPath+"extent-config.xml"));
		test=extent.startTest("NewTest16-"+O.CurrentTime(),"Example.Module1");
	...
	@Test				
	public void Module4NewTest16() throws Exception{
