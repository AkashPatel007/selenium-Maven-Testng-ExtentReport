...
public class NewTest19 extends ExtentFactory{
...
*/
	...
	public void beforeTest() throws IOException {
		...
		extent.loadConfig(new File(c.RootFolderPath+"extent-config.xml"));
		test=extent.startTest("NewTest19-"+O.CurrentTime(),"Example.Module1");
	...
	@Test				
	public void Module4NewTest19() throws Exception{
