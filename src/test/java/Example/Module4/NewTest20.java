...
public class NewTest20 extends ExtentFactory{
...
*/
	...
	public void beforeTest() throws IOException {
		...
		extent.loadConfig(new File(c.RootFolderPath+"extent-config.xml"));
		test=extent.startTest("NewTest20-"+O.CurrentTime(),"Example.Module1");
	...
	@Test				
	public void Module4NewTest20() throws Exception{
