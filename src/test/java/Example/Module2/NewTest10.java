...
public class NewTest10 extends ExtentFactory{
...
*/
	...
	public void beforeTest() throws IOException {
		...
		extent.loadConfig(new File(c.RootFolderPath+"extent-config.xml"));
		test=extent.startTest("NewTest10-"+O.CurrentTime(),"Example.Module1");
	...
	@Test				
	public void Module2NewTest10() throws Exception{
